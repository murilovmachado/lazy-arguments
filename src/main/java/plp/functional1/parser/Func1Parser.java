...
import java.util.*;
import plp.functional1.expression.ExpAnd;
import plp.functional1.expression.ExpConcat;
import plp.functional1.expression.ExpEquals;
import plp.functional1.expression.ExpLength;
import plp.functional1.expression.ExpMenos;
import plp.functional1.expression.ExpNot;
import plp.functional1.expression.ExpOr;
import plp.functional1.expression.ExpSoma;
import plp.functional1.expression.ExpSub;
import plp.functional1.expression.Expressao;
import plp.functional1.expression.Id;
import plp.functional1.expression.Valor;
import plp.functional1.expression.ValorBooleano;
import plp.functional1.expression.ValorInteiro;
import plp.functional1.expression.ValorString;
import plp.functional1.expression.*;
...
public class Func1Parser implements Func1ParserConstants {
  ...
  static final public ArgumentoFuncao PArgumentoFuncao() throws ParseException {
  Token token;
  String tokenStr;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case IDENTIFIER:
      token = jj_consume_token(IDENTIFIER);
        ...
        {if (true) return new ArgumentoEager(tokenStr);}
      break;
    case LAZY:
      jj_consume_token(LAZY);
      token = jj_consume_token(IDENTIFIER);
        tokenStr = token.toString();
        {if (true) return new ArgumentoLazy(tokenStr);}
      break;
    default:
      jj_la1[3] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public List PListaArg() throws ParseException {
  List < ArgumentoFuncao > retorno = null;
  ArgumentoFuncao arg;
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      ...
      arg = PArgumentoFuncao();
      if (retorno == null)
      {
        retorno = new ArrayList < ArgumentoFuncao > ();
        retorno.add(arg);
      }
      else
      {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6000,0x8806000,0x98806000,0x10400000,0x10400000,0x210000,0x0,0x0,0x0,0x400,0x400,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x40,0x8000,0xe00000,0xe00000,0x0,};
   }
