...
public enum TipoPrimitivo implements Tipo {
	...
	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#getNome()
	 */
	...
	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#eInteiro()
	 */
	...
	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#eBooleano()
	 */
	...
	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#eString()
	 */
	public boolean eString() {
		return this.eIgual(STRING);
	}

	public boolean eChar() { return this.eIgual(CHAR); }

	public boolean eReal() { return this.eIgual(REAL); }

	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#eIgual(plp.functional1.util.Tipo)
	 */
	...
	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#eValido()
	 */
	...
	/* (non-Javadoc)
	 * @see plp.functional1.util.Tipo#intersecao(plp.functional1.util.Tipo)
	 */
